            ...
            <div className="row" style={{margin: "0px", flexDirection: "column"}}>
                ...
                <div className="col-md-12" id="sidebarNav">
                    ...
                    <h5 style={{paddingLeft: ".5rem", marginLeft: "2em"}}>GENERAL</h5>
                        <hr/>
                        <Link className='nav-link' id="personalInfoLink" to='/profilesetgen' style={{ marginLeft: "2em"}}>
                            <h6>Personal Info</h6>
                        </Link>
                    
                    <h5 style={{ marginTop: "1em", marginLeft: "2em", paddingLeft: ".5rem"}}>NETWORKING</h5>
                    <hr/>
                    <Link className='nav-link' id="skillsLink" to='/profilesetnet' style={{ marginLeft: "2em"}}>
                        <h6>Skills Page</h6>
                    </Link>
